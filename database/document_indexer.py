...
class DataIngestionApp:
    """
    Ties together document loaders, optional chunking, and indexing.
    """
    ...
    def ingest_data(self, cleanup_mode: str = "incremental"):
        ...
        and indexes them using the LangChain indexing API.
        """
        ...
        for loader in tqdm(self.loaders, desc="Processing loaders", unit="loader"):
            if self.config.use_chunking:
                # Use the base class method load_and_split to get chunked documents.
        ...
        if all_documents:
            # Index all documents via the LangChain indexing API.
